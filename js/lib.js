...
function addProduct_v2(product) {
  ...
  myLink.setAttribute("href", "product.html?id=" + id);
...
function loadAllProducts() {
  ...
  for (let i = 0; i < productDatabase.length; i++) {
    addProduct(
      ...
      productDatabase[i].id   // 👈 truyền id vào đây
    );
  }
}
