const productDatabase = [
  ...
  {id:4, name:"Hoa Hồng", price:180000, img:"../assets/hoahồng.webp", productLink:"detail.html",        
  ...
  {id:6, name:"Hoa Cánh Bướm", price:18000, img:"../assets/saonhai.jpg",productLink:"detail.html",desc:"Hoa sao nháy (cánh bướm) tượng trưng cho tình yêu thủy chung, sự kiên cường vượt qua khó khăn, và vẻ đẹp bình dị, thuần khiết. Nó mang thông điệp về niềm vui, sự trọn vẹn và mang lại năng lượng tích cực, may mắn cho gia chủ"},
...
// Xóa loadAllProducts() và DOMContentLoaded
// Chỉ giữ loadProducts + addProduct_v2
